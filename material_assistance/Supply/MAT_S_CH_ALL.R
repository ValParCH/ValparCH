...
wd<-"C:/Users/.../SUPPLY/CODE"
setwd(wd)

###---- loading local variables

reg97<-fread(paste(wd,"BPTABLE","c_gain_9297.csv",sep="/")) #carbon gain tables from national GHG inventory
reg09<-fread(paste(wd,"BPTABLE","c_gain_0409.csv",sep="/")) #carbon gain tables from national GHG inventory
...
dem<-raster("C:\\Users\\...\\DEM_mean_LV95.tif")
...
process_part_1(lulc97,"97")
process_part_1(lulc09,"09")
